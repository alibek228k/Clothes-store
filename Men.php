...
<link rel="stylesheet" href="Man.css" media="screen">
    ...
    <section class="u-clearfix u-section-1" id="sec-4f10">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-list u-repeater u-list-1">
          <div class="u-container-style u-image u-list-item u-repeater-item u-image-1" data-image-width="531" data-image-height="470">
            <div class="u-container-layout u-similar-container u-container-layout-1">
              <h3 class="u-text u-text-body-alt-color u-text-1">outwear</h3>
              <div class="u-border-3 u-border-grey-dark-1 u-expanded-width u-line u-line-horizontal u-line-1"></div>
              <p class="u-text u-text-body-alt-color u-text-2">Jackets<br>T-shirts<br>Sweatshirt<br>Hoodie&nbsp;<br>Jumpers, Cardigans
              </p>
              <a href="" class="u-btn u-btn-rectangle u-button-style u-text-active-palette-1-base u-text-body-color u-text-hover-palette-2-base u-white u-btn-1">&nbsp;more</a>
            </div>
          </div>
          <div class="u-container-style u-image u-list-item u-repeater-item u-image-2" data-image-width="480" data-image-height="480">
            <div class="u-container-layout u-similar-container u-container-layout-2">
              <h3 class="u-text u-text-body-alt-color u-text-3">pants</h3>
              <div class="u-border-3 u-border-grey-dark-1 u-expanded-width u-line u-line-horizontal u-line-2"></div>
              <p class="u-text u-text-body-alt-color u-text-4"><b>&nbsp;<span style="font-weight: 400;">Chinos</span></b>
                <br>&nbsp;Joggers/Sweatpants<br>&nbsp;Slim-Fit Trousers<br>&nbsp;Shorts<br>&nbsp;Jeans<br>
              </p>
              <a href="" class="u-btn u-btn-rectangle u-button-style u-text-active-palette-1-base u-text-body-color u-text-hover-palette-2-base u-white u-btn-2">&nbsp;more</a>
            </div>
          </div>
          <div class="u-container-style u-image u-list-item u-repeater-item u-image-3" data-image-width="1000" data-image-height="667">
            <div class="u-container-layout u-similar-container u-container-layout-3">
              <h3 class="u-text u-text-body-alt-color u-text-5">footwear</h3>
              <div class="u-border-3 u-border-grey-dark-1 u-expanded-width u-line u-line-horizontal u-line-3"></div>
              <p class="u-text u-text-body-alt-color u-text-6">Sandals <br>Topsiders, moccasins<br>Loafers <br>Sneakers
&nbsp;<br>Boots
              </p>
              <a href="" class="u-btn u-btn-rectangle u-button-style u-text-active-palette-1-base u-text-body-color u-text-hover-palette-2-base u-white u-btn-3">more</a>
            </div>
          </div>
        </div>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-section-2" id="sec-5252">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-expanded-width u-tab-links-align-left u-tabs u-tabs-1">
          <ul class="u-border-2 u-border-palette-1-base u-spacing-10 u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a class="active u-active-palette-1-base u-button-style u-grey-10 u-tab-link u-text-active-white u-text-black u-tab-link-1" id="link-tab-0da5" href="#tab-0da5" role="tab" aria-controls="tab-0da5" aria-selected="true">outerwear</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-palette-1-base u-button-style u-grey-10 u-tab-link u-text-active-white u-text-black u-tab-link-2" id="link-tab-14b7" href="#tab-14b7" role="tab" aria-controls="tab-14b7" aria-selected="false">pants</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-palette-1-base u-button-style u-grey-10 u-tab-link u-text-active-white u-text-black u-tab-link-3" id="link-tab-2917" href="#tab-2917" role="tab" aria-controls="tab-2917" aria-selected="false">footwear</a>
            </li>
            <li class="u-tab-item u-tab-item-4" role="presentation">
              <a class="u-active-palette-1-base u-button-style u-grey-10 u-tab-link u-text-active-white u-text-black u-tab-link-4" id="tab-93fc" href="#link-tab-93fc" role="tab" aria-controls="link-tab-93fc" aria-selected="false">аccessories</a>
            </li>
          </ul>
          <div class="u-tab-content">
            <div class="u-container-style u-tab-active u-tab-pane u-white u-tab-pane-1" id="tab-0da5" role="tabpanel" aria-labelledby="link-tab-0da5">
              <div class="u-container-layout u-container-layout-1">
                <h4 class="u-text u-text-1">Men's outwear&nbsp;</h4>
                  ...
                  <table class="u-table-entity">
                    ...
                    <tbody class="u-table-alt-grey-5 u-table-body">
                      <tr style="height: 26px;">
                        <td class="u-table-cell">Jackets</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Photos</td>
                      </tr>
                      <tr style="height: 51px;">
                        <td class="u-table-cell">T-shirts</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Photos</td>
                      </tr>
                      <tr style="height: 51px;">
                        <td class="u-table-cell">Sweatshirt</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Photos</td>
                      </tr>
                      <tr style="height: 51px;">
                        <td class="u-table-cell">Hoodie</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Photos</td>
                      </tr>
                      <tr style="height: 52px;">
                        <td class="u-table-cell">Jumpers, Cardigans</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Photos</td>
                      </tr>
                ...
                <div class="u-expanded-width u-table u-table-responsive u-table-4">
                  <table class="u-table-entity">
                    ...
                    <tbody class="u-table-alt-grey-5 u-table-body">
                      ...
                      <tr style="height: 51px;">
                        <td class="u-table-cell">T-shirts, sweatshirt</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Photos</td>
                      </tr>
                      <tr style="height: 51px;">
                        <td class="u-table-cell">Suits</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Description</td>
                        <td class="u-table-cell">Photos</td>
                      </tr>
    ...
    <section class="u-align-center u-clearfix u-grey-5 u-section-3" id="sec-6653">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
